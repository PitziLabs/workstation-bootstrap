...
#
# Usage:
#   Interactive:      bash setup-xubuntu-workstation.sh
#   Semi-automated:   GH_TOKEN=ghp_xxx bash setup-xubuntu-workstation.sh
#   Fully unattended: GH_TOKEN=ghp_xxx bash setup-xubuntu-workstation.sh
...
#  16.  XRDP configuration (remote desktop from Chromebook)
#
...
format = "[$path]($style) "
style = "bold cyan"
# [CHANGE] Increased scan timeout for large repos (aws-lab-infra etc.)
scan_timeout = 100
...
section "16/$TOTAL_STEPS — XRDP Remote Desktop"
