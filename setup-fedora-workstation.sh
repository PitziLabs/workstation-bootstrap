...
#
# Usage:
#   Interactive:      bash setup-fedora-workstation.sh
#   Semi-automated:   GH_TOKEN=ghp_xxx bash setup-fedora-workstation.sh
#   Fully unattended: GH_TOKEN=ghp_xxx bash setup-fedora-workstation.sh
#   From a URL:       curl -sL https://raw.githubusercontent.com/PitziLabs/workstation-bootstrap/main/setup-fedora-workstation.sh | GH_TOKEN=ghp_xxx bash
#
...
END_MARKER="# <<< setup-fedora-workstation <<<"
...
section "15/$TOTAL_STEPS — Clone All GitHub Repos (${GITHUB_USER:-<unknown>})"
